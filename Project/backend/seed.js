...
async function seed() {
  try {
    ...
    const project1 = new Project({ name: "Project One", description: "First demo project", owner: user1._id });
    const project2 = new Project({ name: "Project Two", description: "Second demo project", owner: user2._id });
    await project1.save();
    await project2.save();
